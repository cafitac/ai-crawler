...
function publishedPythonSpec(env = process.env) {
  return env.AI_CRAWLER_PYTHON_SPEC || 'git+https://github.com/cafitac/ai-crawler.git[all]';
}
...
Environment overrides:
  - AI_CRAWLER_PYTHON_SPEC   Override published Python package spec (default: git+https://github.com/cafitac/ai-crawler.git[all])
